 ...
 */
function persistBundle(_x, _x2, _x3) {
  return _persistBundle.apply(this, arguments);
}
function _persistBundle() {
  _persistBundle = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(req, AB, bundle) {
    var createdIds, tryDestroy, runCreate, processDef, procRow, childObjs, _iterator, _step, child, c, row, i, _t2, _t3;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          createdIds = [];
          tryDestroy = /*#__PURE__*/function () {
              ...
              return _regenerator().w(function (_context) {
                while (1) switch (_context.p = _context.n) {
                  case 0:
                    ...
                    _context.n = 1;
                    return req.retry(function () {
                      return AB.definitionDestroy(req, id);
                    });
                  case 1:
                    _context.n = 3;
                    break;
                  ...
                  case 4:
                    _context.p = 4;
                    _t = _context.v;
                    req.log("ab_mvc bundle rollback: destroy failed", id, _t);
                  case 5:
                    return _context.a(2);
                }
              }, _callee, null, [[0, 4]]);
            }));
            return function tryDestroy(_x4) {
              return _ref.apply(this, arguments);
            };
          }();
          runCreate = function runCreate(def) {
            if (typeof req.retry === "function") {
              return req.retry(function () {
          ...
          _context2.n = 2;
          return runCreate(processDef);
        case 2:
          procRow = _context2.v;
          createdIds.push(procRow.id);
          childObjs = [];
          _iterator = _createForOfIteratorHelper(bundle.children);
          _context2.p = 3;
          _iterator.s();
        case 4:
        ...
        case 12:
          ...
          _context2.n = 13;
          return tryDestroy(createdIds[i]);
        case 13:
          i--;
          _context2.n = 12;
          break;
    ...
    }, _callee2, null, [[3, 8, 9, 10], [1, 11]]);
  }));
  return _persistBundle.apply(this, arguments);
}
module.exports = {
  persistBundle: persistBundle
};
...
var _require = __webpack_require__(/*! zod */ "./node_modules/zod/index.cjs"),
  z = _require.z;
var translationSchema = z.object({
  language_code: z.string(),
  label: z.string()
});
var processInnerJsonSchema = z.object({
  id: z.string().uuid(),
  name: z.string(),
...
var definitionRowSchema = z.object({
  id: z.string().uuid(),
  name: z.string(),
  type: z.string().min(1),
  json: z.any()
}).strict();
var definitionBundleSchema = z.object({
  process: z.object({
    id: z.string().uuid(),
    name: z.string(),
...
module.exports = {
  definitionBundleSchema: definitionBundleSchema,
  processInnerJsonSchema: processInnerJsonSchema,
  definitionRowSchema: definitionRowSchema
};

/***/ },

/***/ "./service/serviceRegister.js"
/*!************************************!*\
  !*** ./service/serviceRegister.js ***!
  \************************************/
(module, __unused_webpack_exports, __webpack_require__) {

var _require = __webpack_require__(/*! ./schema */ "./service/schema.js"),
  definitionBundleSchema = _require.definitionBundleSchema;
var _require2 = __webpack_require__(/*! ./validate */ "./service/validate.js"),
  validateBundleSemantics = _require2.validateBundleSemantics;
var _require3 = __webpack_require__(/*! ./persist */ "./service/persist.js"),
  persistBundle = _require3.persistBundle;
function parseBundle(bundleParam) {
  var raw = typeof bundleParam === "string" ? JSON.parse(bundleParam) : bundleParam;
...
function validateBundleSemantics(bundle) {
  var proc = bundle.process,
    children = bundle.children;
  var inner = proc.json;
  if (inner.id !== proc.id) {
    throw new Error("process.json.id (".concat(inner.id, ") must match process.id (").concat(proc.id, ")"));
  }
  var childById = new Map(children.map(function (c) {
    return [c.id, c];
  }));
  if (childById.size !== children.length) {
    throw new Error("duplicate child definition id in bundle.children");
  }
  var _iterator = _createForOfIteratorHelper(inner.elementIDs),
    _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var elId = _step.value;
      if (!childById.has(elId)) {
        throw new Error("process.json.elementIDs entry ".concat(elId, " has no matching child row"));
      }
    }
  } catch (err) {
    _iterator.e(err);
  ...
  var xml = inner.xmlDefinition;
  for (var i = 0; i < children.length; i++) {
    var row = children[i];
    var j = row.json;
    if (j.processID != null && j.processID !== proc.id) {
      throw new Error("child[".concat(i, "] json.processID must match process id (").concat(proc.id, ")"));
    }
    if (j.id != null && j.id !== row.id) {
      throw new Error("child[".concat(i, "] json.id must match row id (").concat(row.id, ")"));
    }
    var diagramID = j.diagramID;
    if (diagramID != null && typeof diagramID === "string") {
      if (!xml.includes(diagramID)) {
        throw new Error("child[".concat(i, "] json.diagramID \"").concat(diagramID, "\" not found in process.json.xmlDefinition"));
      }
    }
  }
  return bundle;
...
module.exports = {
  validateBundleSemantics: validateBundleSemantics
};
...
//# sourceMappingURL=ABAbMvc_service.js.map